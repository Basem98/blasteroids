...
de_asteroid.o: asteroid.c
	gcc -c asteroid.c -o de_asteroid.o

de_blast.o: blast.c
	gcc -c -g blast.c -o de_blast.o

de_blasteroids: de_blasteroids.o de_spaceship.o de_asteroid.o de_blast.o
	gcc -g de_blasteroids.o de_spaceship.o de_asteroid.o de_blast.o -lm -o de_blasteroids $(shell pkg-config allegro-5 allegro_font-5 allegro_primitives-5 allegro_audio-5 allegro_acodec-5 --libs --cflags)
